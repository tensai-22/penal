// EJEMPLO DE ARCHIVO: src/components/principal.jsx
// Nota: deja tus imports como los tengas; aquí muestro los mínimos para que el JSX tenga sentido.
...
// Opción 1: con extensión explícita (más seguro)
import BusquedaRapida from './common-principal/busqueda-rapida.jsx';


    const API_BASE_URL = 'http://10.50.5.49:5001'; // Ajustar si es necesario

const Principal = ({ isLoggedIn, role, username }) => {
  // 👇👇👇 Tus const/estados/funciones van afuera. Yo no los declaro a propósito.
  // const [openBusquedaRapida, setOpenBusquedaRapida] = useState(false);
  // const [tab, setTab] = useState(0);
  // ... etc.

  // --- ESTADOS BASE QUE FALTAN ---
const [datos, setDatos] = useState([]);       // ← lista principal
...
const [selectedAbogado, setSelectedAbogado] = useState(""); // usado en filtros/exports
const [mostrarArchivados, setMostrarArchivados] = useState(false); // checkbox archivados
            ...
            <>
              <Box mb={2}>
                <Grid container spacing={2} alignItems="center">
                  ...
                  {/* Ingresar Nuevo Caso (solo admin) */}
                  {role === 'admin' && (
                        ...
                        <>
                          ...
                          {tipoRegistro === 'LEGAJO' && (
                            <>
                              ...
                              {/* Autocomplete de Fiscalía (mantén tus props)
                              <Autocomplete
                          ...
                          <Box sx={{ mb: 2 }}>
                            ...
                            >
                              {noPdf
                                ? "Desmarcar 'No hay evidencia virtual'"
                                : 'No hay evidencia virtual'}
                            </Button>
                          </Box>
              ...
              <Box sx={{ height: 600, width: '100%' }}>
                <DataGrid
                  ...
                  getRowHeight={(params) => (params.model.type === 'yearHeader' ? 32 : 'auto')}
                    ...
                    <Table size="small">
                      <TableBody>
                        {Object.keys(modalFieldLabels).map((key) => {
                          if (impulsoTempSeleccionado && Object.prototype.hasOwnProperty.call(impulsoTempSeleccionado, key)) {
                    ...
                    {impulsoTempSeleccionado &&
                      Object.entries(impulsoTempSeleccionado).map(([key, value], idx) => (
                        <Typography key={idx} variant="body1">
                          ...
                          {['fecha_de_archivo', 'fecha_e_situacional', 'fecha_ingreso', 'last_modified'].includes(key) && value
